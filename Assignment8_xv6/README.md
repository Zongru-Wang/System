...
They are stored under the "context" in the file called proc.h
...
4. What are the 6 possible states of a process?  Also, give a brief phrase describing the purpose of each state.
	1. UNUSED    // the process haven be used
	2. EMBRYO    // the process is being created
	3. SLEEPING  // blocked for an I/O 
	4. RUNNABLE  // the process is ready to run
	5. RUNNING   // the process is currently executing
	6. ZOMBIE    // the process has completed execution but still has an entry in the process table  
	
	
5. What is the function that does a context switch between two processes? *your answer here*

The function is called "switch" in the file named swith.s
