...
- Name: Zongru Wang
- How many hours did it take you to complete this assignment?  80 hours ...
- Did you collaborate with any other students/TAs/Professors?  Yes, went to office hour eveyday.
- Did you use any external resources? (Cite them below) 
  - Google
  - StackOverflow
  - Youtube
- (Optional) What was your favorite part of the assignment? Not part 1 at least...
- (Optional) How would you improve the assignment?  Part 1 is too much for a week learning.
...
Pro:
1. It can find the bug/weakness in the code at the specisific location.
2. If a developer fully understand the code, static analysis can be built.
3. It can find the bug/weakness earlier, which reduce the cost to fix the code.

Con:
1. It time consuming using static analysis since it needs to conduct the code manually.
2. A person needs to understand the code fully to conduct static analysis, and not everyone can.
3. the analysis tools don't support all programming languages.
...
Pro:
1. It can analysis the application which you don not have the access to the actual code.
2. It can identifies the weakness during running time.
3. We can decide what the tools scan for.

Con:
1. It is hard to trace the locations of weakness in the code.
2. The rules defined in the analysis tools determin how good the tool is, and it is not easy to conduct a dynanmic analysis tool. 
...
1. What was the bug?
The bug occurs on line 15, method name "initialize_front ()"
Program received signal SIGSEGV, Segmentation fault.

2. What line did the bug occur?
In line 15
3. What is the fix for the bug?
In c file, did't initialize a pointer and tried to give a value to this pionter which casues the bug.
