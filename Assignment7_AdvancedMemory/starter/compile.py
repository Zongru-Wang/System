...
os.system('clang -lpthread tests/muti-threads.c -o tests/muti-threads')
...
# os.system('valgrind ./tests/muti-threads')
...
os.system('clang -I. -lpthread -o ./tests/muti_mymalloc ./tests/muti-threads.c mymalloc.o')
